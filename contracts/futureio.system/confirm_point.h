...
#include "block_header_ext_key.h"
    ...
    uint8_t from_hex( char c ) {
      ...
      futureio_assert(false, "wrong character in hex string");
      return 0;
    }
...
namespace futureiosystem {
    class confirm_point {
    public:
        static bool is_confirm_point(const futureio::block_header& header) {
        ...
        static block_id_type get_confirmed_block_id(const futureio::block_header& header) {
