...
#include <futureio.system/native.hpp>
...
#include <futureiolib/block_header.hpp>
...
namespace futureiosystem {
   ...
   const name self_chain_name{N(futureio)};
   const account_name futureio_account_name{N(futureio)};
   ...
   const account_name futureio_community_name{N(futio.cmnity)};
   const account_name futureio_technical_team_name{N(futio.thteam)};
   const account_name futureio_dapp_name{N(futio.dapp)};
   const char* bank_issue_memo = "issue tokens for subchain futio.bank";
   ...
   struct exten_type {
       ...
       uint16_t         key;
       std::string      value;
       FUTURELIB_SERIALIZE(exten_type , (key)(value) )
   };

   typedef std::vector<exten_type>  exten_types;

   struct futureio_global_state : futureio::blockchain_parameters {
      uint64_t free_ram()const { return max_ram_size - total_ram_bytes_used; }
      bool is_master_chain()const { return chain_name == name{N(futureio)}; }
      ...
      std::vector<futureio::block_reward> block_reward_vec;
      ...
      name                 chain_name = name{N(futureio)};
      ...
      FUTURELIB_SERIALIZE_DERIVED(futureio_global_state, futureio::blockchain_parameters,
   ...
   struct lwc_parameters {
       ...
       FUTURELIB_SERIALIZE(lwc_parameters, (save_blocks_num))
   };
   ...
   struct chain_resource {
       ...
       FUTURELIB_SERIALIZE(chain_resource, (max_resources_number)(total_resources_used_number)
                            (max_ram_size)(total_ram_bytes_used) )
   };

   struct producer_brief {
      account_name          owner;
      name                  location{N(futureio)};
      ...
      FUTURELIB_SERIALIZE(producer_brief, (owner)(location)(in_disable) )
   };
   ...
   struct producer_ext {
      ...
      FUTURELIB_SERIALIZE(producer_ext, (owner)(chain_type)(table_extension) )
   };
   typedef futureio::multi_index< N(prodext), producer_ext > prodexten_table;
   ...
   struct blocks_per_day {
       ...
       uint32_t block_num;
       uint32_t month;
       FUTURELIB_SERIALIZE(blocks_per_day, (block_num)(month))
   };

   struct producer_history {
      account_name          owner;
      uint64_t              total_produce_block = 0;
      uint64_t              delegated_enable_timestamp = 0;
      std::vector<blocks_per_day> pay_per_day;
      exten_types           table_extension;

      uint64_t primary_key()const { return owner; }

      FUTURELIB_SERIALIZE(producer_history, (owner)(total_produce_block)(delegated_enable_timestamp)(pay_per_day)(table_extension) )
   };
   typedef futureio::multi_index< N(prodhistory), producer_history > prodhistory_table;
   ...
   struct disabled_producer : public committee_info {
      ...
      FUTURELIB_SERIALIZE_DERIVED( disabled_producer, committee_info, (total_cons_staked)
   ...
   struct producer_info : public disabled_producer {
      ...
      FUTURELIB_SERIALIZE_DERIVED( producer_info, disabled_producer,
   ...
   struct unpaid_disproducer {
      ...
      exten_types    table_extension;
      uint64_t  primary_key()const { return owner; }
      FUTURELIB_SERIALIZE( unpaid_disproducer, (owner)(unpaid_balance)(reward_account)(table_extension) )
   };
   typedef futureio::multi_index< N(upaiddisprod), unpaid_disproducer>      unpaid_disprod;
   ...
   struct hash_vote {
       ...
       FUTURELIB_SERIALIZE(hash_vote , (hash)(file_size)(votes)(valid)(accounts) )
   };
   ...
   struct block_ws_hash {
       ...
       FUTURELIB_SERIALIZE( block_ws_hash , (block_num)(hash)(table_extension) )
   };
   ...
   struct subchain_ws_hash {
       ...
       exten_types           table_extension;
       uint64_t  primary_key()const { return block_num; }
       FUTURELIB_SERIALIZE( subchain_ws_hash , (block_num)(hash_v)(accounts)(table_extension) )
   };
   ...
   struct master_chain_info {
       ...
       uint64_t  primary_key()const { return owner; }
       FUTURELIB_SERIALIZE(master_chain_info, (owner)(master_prods)(block_height)(block_id)(committee_mroot)(master_chain_ext) )
   };

   typedef futureio::multi_index<N(briefprod),producer_brief> producer_brief_table;
   typedef futureio::multi_index<N(disableprods), disabled_producer> disabled_producers_table;
   typedef futureio::multi_index<N(producers), producer_info> producers_table;
   typedef futureio::singleton<N(global), futureio_global_state> global_state_singleton;
   typedef futureio::multi_index< N(wshash), subchain_ws_hash>      subchain_hash_table;
   typedef futureio::multi_index< N(blockwshash), block_ws_hash>    block_ws_hash_table;
   typedef futureio::multi_index<N(masterinfos),master_chain_info> master_chain_infos;
   typedef futureio::singleton<N(lwc), lwc_parameters>  lwc_singleton;
   ...
   struct chaintype {
       ...
       FUTURELIB_SERIALIZE(chaintype, (type_id)(stable_min_producers)(stable_max_producers)
                            (sched_inc_step)(consensus_period)(table_extension) )
   };
   typedef futureio::multi_index< N(chaintypes), chaintype > chaintypes_table;
   ...
   struct changing_producer : public committee_info {
      ...
      FUTURELIB_SERIALIZE_DERIVED( changing_producer, committee_info, (block_num))
   };
   ...
   struct block_header_digest {
       ...
       futureio::extensions_type           table_extension;
       ...
       FUTURELIB_SERIALIZE(block_header_digest, (block_number)(transaction_mroot)(trx_ids)(table_extension))
   };

   typedef futureio::multi_index<N(blockheaders), block_header_digest> block_table;

   struct unconfirmed_block_header : public futureio::signed_block_header {
       block_id_type              block_id;
       uint32_t                   block_number = 0;
       ...
       unconfirmed_block_header(const futureio::signed_block_header& signed_header, const block_id_type& b_id, uint32_t b_n,
                                bool need_pay, bool is_sync) : futureio::signed_block_header(signed_header),
       ...
       FUTURELIB_SERIALIZE_DERIVED(unconfirmed_block_header, futureio::signed_block_header,(block_id)(block_number)
   ...
   struct chain_info {
       ...
       FUTURELIB_SERIALIZE(chain_info, (chain_name)(chain_type)(genesis_time)(global_resource)(is_synced)
   ...
   typedef futureio::multi_index<N(chains), chain_info> chains_table;

   struct futureio_system_params {
      futureio_system_params(){}
      uint64_t             chain_type;
      ...
      FUTURELIB_SERIALIZE( futureio_system_params,(chain_type)(max_ram_size)(min_activated_stake)
   ...
   struct chain_commercial_delegate{
       ...
       FUTURELIB_SERIALIZE( chain_commercial_delegate, (chain_name)(delegate_value) )
   };
   typedef futureio::multi_index< N(chaincommdel), chain_commercial_delegate>      chain_comm_del_table;
   ...
   struct resources_lease {
      ...
      FUTURELIB_SERIALIZE( resources_lease, (owner)(lease_num)(start_block_height)
   ...
   struct free_account {
      ...
      exten_types    table_extension;
      uint64_t  primary_key()const { return owner; }
      FUTURELIB_SERIALIZE( free_account, (owner)(acc_num)(table_extension) )
   };
   typedef futureio::multi_index< N(freeacc), free_account>      freeaccount;
   ...
   typedef futureio::singleton<N(schedset), schedule_setting> sched_set_singleton;
   ...
   typedef futureio::multi_index< N(cmtbltn), committee_bulletin>    cmtbulletin;
   ...
   struct bulletin {
       ...
       exten_types           table_extension;
       uint64_t  primary_key()const { return block_num; }
       FUTURELIB_SERIALIZE( bulletin , (block_num)(action_name)(table_extension) )
   };
   typedef futureio::multi_index< N(bltn), bulletin>    bulletintab;
   ...
   struct evilprod {
       ...
       exten_types           table_extension;
       uint64_t  primary_key()const { return owner; }
       FUTURELIB_SERIALIZE( evilprod , (owner)(evil_type)(is_freeze)(table_extension) )
   };
   typedef futureio::multi_index< N(evilprod), evilprod>    evilprodtab;
   ...
   struct moveprod_param {
       ...
       FUTURELIB_SERIALIZE(moveprod_param, (producer)(producerkey)(blskey)(from_disable)(from_chain)(to_disable)(to_chain) )
   };
    ...
    struct evildoer {
        ...
        std::string bls_pk;
        FUTURELIB_SERIALIZE(evildoer, (account)(commitee_pk)(bls_pk))
    };
    ...
    struct new_chain_info {
        ...
        account_name first_period_buyer = N(futureio);
        ...
        FUTURELIB_SERIALIZE(new_chain_info, (chain_name)(chain_type)(genesis_producer_pk)(genesis_time)(master_block_height)
                  (first_period_buyer)(creation_status)(pending_producer_num)(extensions))
    };
    typedef futureio::singleton<N(newchain), new_chain_info> new_chain_singleton;

    enum committee_ope_type {
        fixed_committee_remove = 0,
        fixed_committee_add,
        fixed_committee_end,
    };
    struct fixed_committee {
        account_name                      producer;
        auto primary_key() const { return producer; }
        FUTURELIB_SERIALIZE(fixed_committee, (producer))
    };
   typedef futureio::multi_index<N(fixedcmt), fixed_committee> fixed_committee_table;

   class system_contract : public native {
      private:
         global_state_singleton   _global;
         futureio_global_state   _gstate;
         ...
         bool accept_block_header(name chain_name, const futureio::signed_block_header& header, char* confirmed_bh_hash, size_t hash_size);
      ...
      public:
         ...
         */
         ...
         void opefixedprod( uint16_t ope_type, const std::vector<account_name>& prod_vec );
         ...
         void acceptmaster(const std::vector<futureio::signed_block_header>& headers);
         ...
         // functions defined in futureio.system.cpp
         void setsysparams( const futureio_system_params& params );
         ...
         inline uint64_t getchaintypeextenuintdata( const futureiosystem::chaintypes_table::const_iterator& type_iter, uint16_t key, uint64_t default_value ) const;
         void setmasterchaininfo( const master_chain_info& chaininfo );
         void setparams( const futureio::blockchain_parameters& params );
      ...
      private:
         // functions defined in futureio.system.cpp
         void add_subchain_account(const futureio::proposeaccount_info& newacc );
         static futureio_global_state get_default_parameters();
         ...
         inline uint32_t check_previous_claimed_reward( const futureiosystem::producer_info& prod,uint32_t block_height ) const;
         ...
         inline void add_rewards_for_disproducer( account_name producer, account_name reward_account, uint64_t unpaid_balance );
         ...
         //defined in futureio.system.cpp
   ...
   extern "C" {
    ...
    void empower_to_chain(account_name user, futureio::name chain_name);
    bool is_empowered(account_name user, futureio::name chain_name);
    bool lightclient_accept_block_header(futureio::name chain_name, const char* bh, size_t bh_size, char* confirmed_bh_buffer, size_t buffer_size);
