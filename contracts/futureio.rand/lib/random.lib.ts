...
import { queryBalance } from "../../node_modules/future-ts-lib/lib/balance";
...
export const CONT_NAME = "futio.rand";
...
export class Random {
  ...
  public query(bckNum: u64): RandRecord {
    ...
    future_assert(minBckNum <= bckNum && bckNum <= maxBckNum, "Currently the block number of the rand should be between " + intToString(minBckNum) + " and " + intToString(maxBckNum));
