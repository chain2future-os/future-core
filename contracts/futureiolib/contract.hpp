 ...
 * @ingroup types
 * @brief Defines contract type which is %base class for every FUTUREIO contract
 * 
 * @{
 * 
 */
...
/**
 * @brief %Base class for FUTUREIO contract.
 * @details %Base class for FUTUREIO contract. %A new contract should derive from this class, so it can make use of FUTUREIO_ABI macro.
 */
class contract {
   public:
      /**
