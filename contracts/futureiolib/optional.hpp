   ...
   class optional {
      public:
         ...
         */
          ...
          */
         T&       operator*()      { futureio_assert(_valid, "dereference of empty optional"); return ref(); }
          ...
          * @return T& - Contained value
          */
         const T& operator*()const { futureio_assert(_valid, "dereference of empty optional"); return ref(); }
         ...
         T*       operator->()
         {
            futureio_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         *  @return futureio::datastream<Stream>& - Reference to the datastream
         */
         template<typename Stream>
         friend inline futureio::datastream<Stream>& operator>> (futureio::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         */
         template<typename Stream>
         friend inline futureio::datastream<Stream>& operator<< (futureio::datastream<Stream>& ds, const optional& op)
         {
