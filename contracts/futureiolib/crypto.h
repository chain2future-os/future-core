 ...
 *  futureio::print("sha256 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  futureio::print("sha1 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  futureio::print("sha512 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  futureio::print("ripemod160 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  future_assert( calc_hash == hash, "invalid hash" );
 *  @endcode
 */
 ...
 *  futureio::print("pub key matches the pub key generated from digest");
 *  @endcode
 */
...
int ts_check_shielded_transaction(const char* trx_bytes, size_t len);
int ts_update_inc_merkle_tree(const char* merkle_bytes, size_t merkle_len, uint32_t buffer_len, const char* cm_bytes, size_t cm_len,
                              const char* anchor_bytes, size_t anchor_len, const char* pos_bytes, size_t pos_len);
#endif
/// }@cryptocapi
