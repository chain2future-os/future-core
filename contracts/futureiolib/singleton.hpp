...
namespace  futureio {
    ...
    *  @brief Defines FUTUREIO Singleton Table
    *  @ingroup databasecpp 
    *  @{
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         FUTURELIB_SERIALIZE( row, (value) )
      };

      typedef futureio::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            futureio_assert( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
