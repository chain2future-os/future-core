...
/**
 * @brief FUTUREIO Public Key
 * @details FUTUREIO Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
...
/**
 * @brief FUTUREIO Signature
 * @details FUTUREIO Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of FUTUREIO Transaction Id
 * @details Type of FUTUREIO Transaction Id. It is 256-bit hash
 */
