...
namespace futureio {
  class microseconds {
    public:
        ...
        int64_t _count;
        FUTURELIB_SERIALIZE( microseconds, (_count) )
    private:
  ...
  class time_point {
    public:
        ...
        FUTURELIB_SERIALIZE( time_point, (elapsed) )
  };
  ...
  class time_point_sec
  {
    public:
        ...
        operator time_point()const { return time_point( futureio::seconds( utc_seconds) ); }
        uint32_t sec_since_epoch()const { return utc_seconds; }

        time_point_sec operator = ( const futureio::time_point& t )
        {
          utc_seconds = uint32_t(t.time_since_epoch().count() / 1000000ll);
          return *this;
        }
        ...
        FUTURELIB_SERIALIZE( time_point_sec, (utc_seconds) )
  };
   ...
   **/
   class block_timestamp {
      public:
         ...
         FUTURELIB_SERIALIZE( block_timestamp, (abstime) )
      private:
