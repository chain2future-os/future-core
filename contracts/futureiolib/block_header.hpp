...
namespace futureio {
...
#ifdef CONSENSUS_VRF
      FUTURELIB_SERIALIZE( block_header, (timestamp)(proposer)(proposerProof)(version)(previous)
                                          (transaction_mroot)(action_mroot)(committee_mroot)(header_extensions) )
#else
      FUTURELIB_SERIALIZE( block_header, (timestamp)(proposer)(version)(previous)
                                          (transaction_mroot)(action_mroot)(committee_mroot)(header_extensions) )
#endif
   ...
   struct signed_block_header : public block_header
   {
      ...
      FUTURELIB_SERIALIZE_DERIVED(signed_block_header, block_header, (signature))
   };
}
