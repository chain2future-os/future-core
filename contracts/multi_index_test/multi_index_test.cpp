...
#include <futureiolib/dispatcher.hpp>
...
struct limit_order {
   ...
   account_name owner;
      ...
      FUTURELIB_SERIALIZE( limit_order, (id)(price)(expiration)(owner) )
   };
   ...
   struct test_k256 {
      ...
      FUTURELIB_SERIALIZE( test_k256, (id)(val) )
   };
   ...
   class multi_index_test {
      public:
         ...
         ACTION(N(multitest), trigger) {
            ...
            FUTURELIB_SERIALIZE(trigger, (what))
         };
         ...
         static void on(const trigger& act)
         {
            ...
            switch(act.what)
            {
               case 0:
               {
                  ...
                  futureio::multi_index<N(orders), limit_order,
               ...
               case 1: // Test key265 secondary index
               {
                  ...
                  futureio::multi_index<N(test1), test_k256,
               ...
               break;
               default:
                  futureio_assert(0, "Given what code is not supported.");
               break;
            }
         }
   };
...
namespace multi_index_test {
   extern "C" {
      ...
      void apply( uint64_t /* receiver */, uint64_t code, uint64_t actH, uint64_t actL ) {
         ...
         require_auth(code);
         futureio_assert(futureio::dispatch<multi_index_test, multi_index_test::trigger>(code, action),
                      "Could not dispatch");
      }
   }
}
