...
private:
    ...
    int64_t fee = 0;
    libzcash::SaplingSpendingKey skey;
    libzcash::SaplingPaymentAddress regPaymentAddr;
...
public:
    ...
    void SetSpendKey(const libzcash::SaplingSpendingKey& skey);

    void SetRegPaymentAddress(const libzcash::SaplingPaymentAddress& addr);
