...
#define SAPLING_INCREMENTAL_MERKLE_TREE_DEPTH 10 
...
#define ZC_PUBLIC_KEY_SIZE (32+32+ZC_DIVERSIFIER_SIZE) 

#define ZC_NOTEPLAINTEXT_SIZE (ZC_NOTEPLAINTEXT_LEADING + ZC_V_SIZE + ZC_RHO_SIZE + ZC_R_SIZE + ZC_MEMO_SIZE)

#define ZC_SAPLING_ENCPLAINTEXT_SIZE (ZC_NOTEPLAINTEXT_LEADING + ZC_DIVERSIFIER_SIZE + ZC_V_SIZE + ZC_R_SIZE + sizeof(uint32_t) + ZC_MEMO_SIZE)
