...
FC_REFLECT_ENUM( futureio::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(futureio::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(futureio::chain::transaction_receipt, (futureio::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(futureio::chain::signed_block, (futureio::chain::signed_block_header), (transactions)(block_extensions) )
FC_REFLECT_DERIVED(futureio::chain::block_db_record, (futureio::chain::signed_block_header), (trx_ids)(block_extensions) )
