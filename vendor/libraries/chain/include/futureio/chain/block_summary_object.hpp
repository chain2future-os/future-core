...
CHAINBASE_SET_INDEX_TYPE(futureio::chain::block_summary_object, futureio::chain::block_summary_multi_index)

FC_REFLECT( futureio::chain::block_summary_object, (block_id) )
