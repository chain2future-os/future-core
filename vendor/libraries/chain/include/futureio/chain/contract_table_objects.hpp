...
#include <futureio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(futureio::chain::table_id_object, futureio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(futureio::chain::key_value_object, futureio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(futureio::chain::index64_object, futureio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(futureio::chain::index128_object, futureio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(futureio::chain::index256_object, futureio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(futureio::chain::index_double_object, futureio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(futureio::chain::index_long_double_object, futureio::chain::index_long_double_index)

FC_REFLECT(futureio::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(futureio::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(futureio::chain::index64_object)
REFLECT_SECONDARY(futureio::chain::index128_object)
REFLECT_SECONDARY(futureio::chain::index256_object)
REFLECT_SECONDARY(futureio::chain::index_double_object)
REFLECT_SECONDARY(futureio::chain::index_long_double_object)
