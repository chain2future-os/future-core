...
CHAINBASE_SET_INDEX_TYPE(futureio::chain::permission_link_object, futureio::chain::permission_link_index)

FC_REFLECT(futureio::chain::permission_link_object, (account)(code)(message_type)(required_permission))
