...
namespace futureio { namespace chain { namespace bls_votes {
...
} } } // futureio::chain::bls_votes

CHAINBASE_SET_INDEX_TYPE(futureio::chain::bls_votes::bls_votes_object,        futureio::chain::bls_votes::bls_votes_index)
CHAINBASE_SET_INDEX_TYPE(futureio::chain::bls_votes::bls_votes_current_object,        futureio::chain::bls_votes::bls_votes_current_index)

FC_REFLECT(futureio::chain::bls_votes::bls_votes_info, (block_num)(end_epoch)(valid_bls)(bls_str))
FC_REFLECT(futureio::chain::bls_votes::bls_votes_object, (latest_confirmed_block_num)(latest_check_point_id)(should_be_confirmed))
FC_REFLECT(futureio::chain::bls_votes::worldstate_bls_voters_object, (latest_confirmed_block_num)(latest_check_point_id)(should_be_confirmed))

FC_REFLECT(futureio::chain::bls_votes::bls_votes_current_object, (current_bls_str))
