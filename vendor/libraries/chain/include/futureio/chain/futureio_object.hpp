...
namespace futureio { namespace chain {
   ...
   typedef std::vector<exten_type>  extension_types;
    // keep this the same as defined in futureio.system.hpp;
...
FC_REFLECT(futureio::chain::exten_type, (key)(value) )
FC_REFLECT(futureio::chain::producer_brief, (owner)(location)(in_disable) )
FC_REFLECT(futureio::chain::role_base, (owner)(producer_key)(bls_key) )
FC_REFLECT_DERIVED(futureio::chain::disabled_producer, (futureio::chain::role_base), (total_cons_staked)(url)(total_produce_block)
                    (last_operate_blocknum)(delegated_cons_blocknum)(claim_rewards_account) )
FC_REFLECT_DERIVED(futureio::chain::producer_info, (futureio::chain::disabled_producer),
                    (unpaid_amount)(produce_block_perday)(last_record_blockheight)(table_extension))
FC_REFLECT(futureio::chain::chain_resource, (max_resources_number)(total_resources_used_number)(max_ram_size)(total_ram_bytes_used) )
FC_REFLECT(futureio::chain::user_info, (user_name)(owner_key)(active_key)(emp_time)(is_producer)(block_height)(updateable) )
FC_REFLECT_DERIVED(futureio::chain::changing_producer, (futureio::chain::role_base), (block_num) )
FC_REFLECT(futureio::chain::changing_committee, (removed_members)(new_added_members) )
FC_REFLECT(futureio::chain::block_header_digest, (block_number)(transaction_mroot)(trx_ids)(table_extension) )
FC_REFLECT_DERIVED(futureio::chain::unconfirmed_block_header, (futureio::chain::signed_block_header), (block_id)(block_number)(to_be_paid)
                    (is_leaf)(is_synced)(next_committee_mroot)(table_extension) )
FC_REFLECT(futureio::chain::chain_info, (chain_name)(chain_type)(genesis_time)(global_resource)(is_synced)(is_schedulable)
...
FC_REFLECT(futureio::chain::resources_lease, (owner)(lease_num)(start_block_height)(end_block_height)(modify_block_height)(free_account_number)(table_extension) )
FC_REFLECT(futureio::chain::master_chain_info, (owner)(master_prods)(block_height)(block_id)(committee_mroot)(master_chain_ext) )
FC_REFLECT(futureio::chain::committee_bulletin, (block_num)(change_type) )
FC_REFLECT(futureio::chain::resource_sale, (owner)(lease_num)(initial_unit_price)(decrease_by_day)(modify_block_height)(table_extension) )
