...
struct abi_def {
   ...
   string                version = "futureio::abi/1.0";
...
FC_REFLECT( futureio::chain::type_def                         , (new_type_name)(type) )
FC_REFLECT( futureio::chain::field_def                        , (name)(type) )
FC_REFLECT( futureio::chain::struct_def                       , (name)(base)(fields) )
FC_REFLECT( futureio::chain::action_def                       , (name)(type)(ricardian_contract)(ability) )
FC_REFLECT( futureio::chain::table_def                        , (name)(index_type)(key_names)(key_types)(type) )
FC_REFLECT( futureio::chain::clause_pair                      , (id)(body) )
FC_REFLECT( futureio::chain::error_message                    , (error_code)(error_msg) )
FC_REFLECT( futureio::chain::abi_def                          , (version)(types)(structs)(actions)(tables)
