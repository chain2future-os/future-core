...
CHAINBASE_SET_INDEX_TYPE(futureio::chain::transaction_object, futureio::chain::transaction_multi_index)

FC_REFLECT(futureio::chain::transaction_object, (expiration)(trx_id))