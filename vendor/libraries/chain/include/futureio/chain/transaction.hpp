...
sig_to_pubkey_map_type;
   ...
   struct transaction : public transaction_header {
      ...
      sig_to_pubkey_map_type recover_keys_fresh( const vector<signature_type>& signatures,
                                           const chain_id_type& chain_id, const vector<bytes>& cfd,
...
FC_REFLECT( futureio::chain::transaction_header, (expiration)(ref_block_num)(ref_block_prefix)
                                              (max_net_usage_words)(max_cpu_usage_ms)(delay_sec) )
FC_REFLECT_DERIVED( futureio::chain::transaction, (futureio::chain::transaction_header), (context_free_actions)(actions)(transaction_extensions) )
FC_REFLECT_DERIVED( futureio::chain::signed_transaction, (futureio::chain::transaction), (signatures)(context_free_data) )
FC_REFLECT_ENUM( futureio::chain::packed_transaction::compression_type, (none)(zlib))
FC_REFLECT( futureio::chain::packed_transaction, (signatures)(compression)(packed_context_free_data)(packed_trx) )
FC_REFLECT( futureio::chain::packed_generated_transaction, (packed_trx) )
FC_REFLECT_DERIVED( futureio::chain::deferred_transaction, (futureio::chain::signed_transaction), (sender_id)(sender)(payer)(execute_after) )
FC_REFLECT( futureio::chain::deferred_reference, (sender)(sender_id) )
