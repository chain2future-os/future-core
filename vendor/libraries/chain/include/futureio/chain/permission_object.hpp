...
CHAINBASE_SET_INDEX_TYPE(futureio::chain::permission_object, futureio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(futureio::chain::permission_usage_object, futureio::chain::permission_usage_index)

//TODO: MUST: Need custom the parent
FC_REFLECT(chainbase::oid<futureio::chain::permission_object>, (_id))
FC_REFLECT(futureio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(futureio::chain::worldstate_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

// FC_REFLECT(chainbase::oid<futureio::chain::permission_usage_object>, (_id))
FC_REFLECT(futureio::chain::permission_usage_object, (last_used))
