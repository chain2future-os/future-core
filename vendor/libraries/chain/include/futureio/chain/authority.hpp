...
FC_REFLECT(futureio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(futureio::chain::key_weight, (key)(weight) )
FC_REFLECT(futureio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(futureio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(futureio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
