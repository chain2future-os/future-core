       ...
       public:
        ...
        public:
            ...
            template<typename index_t> void store_backup_indices(chainbase::database& worldstate_db, void* data = nullptr){
                ...
                FUTURE_ASSERT(get_writer() && get_id_writer(), worldstate_exception, "Ws writer is not exist!");
            ...
            template<typename index_t> void read_table_from_worldstate(chainbase::database& worldstate_db, void* data = nullptr){
                FUTURE_ASSERT(get_reader(), worldstate_exception, "Reader is nullptr, maybe ws file don't exist");
...
FC_REFLECT(futureio::chain::ws_info, (chain_id)(block_height)(hash_string)(file_size))
