...
namespace gm {
    namespace sm2 {
        ...
        std::string PublicKey::base58_to_hex(const std::string& base58str) {
            ...
            auto subStr = base58str.substr(strlen(FUT));
            ...
            return futureio::Hex::toHex<unsigned char>((unsigned char*)bin.data(), PublicKey::kSm2PublicKeyCompressedLength, true);
        }
        ...
        std::string PublicKey::bin2Hex(const PublicKey::DataType& data) {
            return futureio::Hex::toHex<unsigned char>((unsigned char*)data.get<PublicKeyData>().begin(), PublicKey::kSm2PublicKeyCompressedLength, false);
        }
        ...
        PublicKey::DataType PublicKey::hex2Bin(const std::string& hexKey) {
            ...
            futureio::Hex::fromHex<unsigned char>(hexKey, (unsigned char*)data.begin(), PublicKey::kSm2PublicKeyCompressedLength);
        ...
        std::string PublicKey::hex2Wif(const std::string& hexKey) {
            ...
            futureio::Hex::fromHex<unsigned char>(hexKey, rawKey, PublicKey::kSm2PublicKeyCompressedLength);
            ...
            return std::string(FUT) + fc::to_base58((char*)rawKey, PublicKey::kSm2PublicKeyCompressedLength + sizeOfHashBytes);
        }
