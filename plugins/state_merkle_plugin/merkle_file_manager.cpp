...
namespace futureio {
    ...
    void merkle_file_writer::write_data(const uint32_t block_num,const futureio::chain::incremental_merkle merkle)
    {
    ...
    void merkle_file_manager::write_data(const uint32_t block_num,const futureio::chain::incremental_merkle merkle)
    {
