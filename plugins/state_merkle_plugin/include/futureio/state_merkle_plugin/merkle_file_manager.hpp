...
namespace futureio {
    ...
    struct merkle_file_writer{
        ...
        futureio::chain::incremental_merkle mroot{};
        bfs::path m_path{};
        std::string         chainid;

        void write_data(const uint32_t block_num,const futureio::chain::incremental_merkle merkle);
...
FC_REFLECT(futureio::merkle_info, (block_num)(merkle))
FC_REFLECT(futureio::merkle_infos, (block_num)(merkle)(isValid)(infos))
