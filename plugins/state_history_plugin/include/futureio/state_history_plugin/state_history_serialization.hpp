...
#include <futureio/chain/resource_limits_private.hpp>
#include <futureio/chain/trace.hpp>
#include <futureio/chain_plugin/chain_plugin.hpp>
#include <futureio/state_history_plugin/state_history_plugin.hpp>
...
datastream<ST>& history_serialize_container(datastream<ST>& ds, const chainbase::database& db,
   ...
   fc::raw::pack(ds, unsigned_int(v.size()));
   for (auto& x : v) {
      FUTURE_ASSERT(!!x, futureio::chain::plugin_exception, "null inside container");
      ds << make_history_serial_wrapper(db, *x);
   }
   return ds;
}
...
template <typename ST>
void history_pack_big_bytes(datastream<ST>& ds, const futureio::chain::bytes& v) {
...
template <typename ST>
void history_pack_big_bytes(datastream<ST>& ds, const fc::optional<futureio::chain::bytes>& v) {
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<futureio::chain::name>& obj) {
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.value));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<futureio::chain::account_object>& obj) {
   ...
   fc::raw::pack(ds, as_type<futureio::chain::block_timestamp_type>(obj.obj.creation_date));
   fc::raw::pack(ds, as_type<futureio::chain::shared_string>(obj.obj.abi));
   ...
   fc::raw::pack(ds, as_type<futureio::chain::digest_type>(obj.obj.code_version));
   history_serialize_container(ds, obj.db, as_type<futureio::chain::shared_vector<futureio::chain::name>>(obj.obj.chain_names));
   fc::raw::pack(ds, as_type<futureio::chain::shared_string>(obj.obj.code));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<futureio::chain::table_id_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
operator<<(datastream<ST>&                                                                               ds,
           const history_context_wrapper<futureio::chain::table_id_object, futureio::chain::key_value_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   ...
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.payer.value));
   fc::raw::pack(ds, as_type<futureio::chain::shared_string>(obj.obj.value));
   return ds;
}
...
template <typename ST>
void serialize_secondary_index_data(datastream<ST>& ds, const futureio::chain::key256_t& obj) {
...
template <typename ST, typename T>
datastream<ST>& serialize_secondary_index(datastream<ST>& ds, const futureio::chain::table_id_object& context,
                                          const T& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
datastream<ST>&
operator<<(datastream<ST>&                                                                             ds,
           const history_context_wrapper<futureio::chain::table_id_object, futureio::chain::index64_object>& obj) {
...
datastream<ST>&
operator<<(datastream<ST>&                                                                              ds,
           const history_context_wrapper<futureio::chain::table_id_object, futureio::chain::index128_object>& obj) {
   return serialize_secondary_index(ds, obj.context, obj.obj);
}
...
datastream<ST>&
operator<<(datastream<ST>&                                                                              ds,
           const history_context_wrapper<futureio::chain::table_id_object, futureio::chain::index256_object>& obj) {
   return serialize_secondary_index(ds, obj.context, obj.obj);
}
...
datastream<ST>&
operator<<(datastream<ST>&                                                                                  ds,
           const history_context_wrapper<futureio::chain::table_id_object, futureio::chain::index_double_object>& obj) {
   return serialize_secondary_index(ds, obj.context, obj.obj);
}
...
datastream<ST>& operator<<(
    datastream<ST>&                                                                                       ds,
    const history_context_wrapper<futureio::chain::table_id_object, futureio::chain::index_long_double_object>& obj) {
   return serialize_secondary_index(ds, obj.context, obj.obj);
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<futureio::chain::chain_config>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
datastream<ST>& operator<<(datastream<ST>&                                                     ds,
                           const history_serial_wrapper<futureio::chain::global_property_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   // fc::raw::pack(ds, as_type<optional<futureio::chain::block_num_type>>(obj.obj.proposed_schedule_block_num));
   // fc::raw::pack(ds, make_history_serial_wrapper(
   //                       obj.db, as_type<futureio::chain::shared_producer_schedule_type>(obj.obj.proposed_schedule)));
   fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<futureio::chain::chain_config>(obj.obj.configuration)));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                           ds,
                           const history_serial_wrapper<futureio::chain::generated_transaction_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.sender.value));
   fc::raw::pack(ds, as_type<__uint128_t>(obj.obj.sender_id));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.payer.value));
   fc::raw::pack(ds, as_type<futureio::chain::transaction_id_type>(obj.obj.trx_id));
   fc::raw::pack(ds, as_type<futureio::chain::shared_string>(obj.obj.packed_trx));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<futureio::chain::key_weight>& obj) {
   fc::raw::pack(ds, as_type<futureio::chain::public_key_type>(obj.obj.key));
   fc::raw::pack(ds, as_type<uint16_t>(obj.obj.weight));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<futureio::chain::permission_level>& obj) {
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                      ds,
                           const history_serial_wrapper<futureio::chain::permission_level_weight>& obj) {
   fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<futureio::chain::permission_level>(obj.obj.permission)));
   fc::raw::pack(ds, as_type<uint16_t>(obj.obj.weight));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<futureio::chain::wait_weight>& obj) {
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<futureio::chain::shared_authority>& obj) {
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<futureio::chain::permission_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.owner.value));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.name.value));
   if (obj.obj.parent._id) {
      auto&       index  = obj.db.get_index<futureio::chain::permission_index>();
      const auto* parent = index.find(obj.obj.parent);
      if (!parent) {
         auto& undo = index.stack().back();
         auto  it   = undo.removed_values.find(obj.obj.parent);
         FUTURE_ASSERT(it != undo.removed_values.end(), futureio::chain::plugin_exception,
   ...
   fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<futureio::chain::shared_authority>(obj.obj.auth)));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                     ds,
                           const history_serial_wrapper<futureio::chain::permission_link_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.account.value));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.code.value));
   fc::raw::pack(ds, as_type<futureio::chain::name_ex>(obj.obj.message_type)); //message_type is name_ex, have 2 uint64
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                                      ds,
                           const history_serial_wrapper<futureio::chain::resource_limits::resource_limits_object>& obj) {
   FUTURE_ASSERT(!obj.obj.pending, futureio::chain::plugin_exception,
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                                 ds,
                           const history_serial_wrapper<futureio::chain::resource_limits::usage_accumulator>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                                     ds,
                           const history_serial_wrapper<futureio::chain::resource_limits::resource_usage_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.owner.value));
   fc::raw::pack(ds, make_history_serial_wrapper(
                         obj.db, as_type<futureio::chain::resource_limits::usage_accumulator>(obj.obj.net_usage)));
   fc::raw::pack(ds, make_history_serial_wrapper(
                         obj.db, as_type<futureio::chain::resource_limits::usage_accumulator>(obj.obj.cpu_usage)));
...
datastream<ST>&
operator<<(datastream<ST>&                                                                            ds,
           const history_serial_wrapper<futureio::chain::resource_limits::resource_limits_state_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<futureio::chain::resource_limits::usage_accumulator>(
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                     ds,
                           const history_serial_wrapper<futureio::chain::resource_limits::ratio>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                                        ds,
                           const history_serial_wrapper<futureio::chain::resource_limits::elastic_limit_parameters>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   ...
   fc::raw::pack(
       ds, make_history_serial_wrapper(obj.db, as_type<futureio::chain::resource_limits::ratio>(obj.obj.contract_rate)));
   fc::raw::pack(
       ds, make_history_serial_wrapper(obj.db, as_type<futureio::chain::resource_limits::ratio>(obj.obj.expand_rate)));
   return ds;
}
...
datastream<ST>&
operator<<(datastream<ST>&                                                                             ds,
           const history_serial_wrapper<futureio::chain::resource_limits::resource_limits_config_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(
       ds, make_history_serial_wrapper(
               obj.db, as_type<futureio::chain::resource_limits::elastic_limit_parameters>(obj.obj.cpu_limit_parameters)));
   fc::raw::pack(
       ds, make_history_serial_wrapper(
               obj.db, as_type<futureio::chain::resource_limits::elastic_limit_parameters>(obj.obj.net_limit_parameters)));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<futureio::chain::action>& obj) {
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.account.value));
   fc::raw::pack(ds, as_type<futureio::chain::name_ex>(obj.obj.name));////name is name_ex, have 2 uint64
   history_serialize_container(ds, obj.db, as_type<std::vector<futureio::chain::permission_level>>(obj.obj.authorization));
   fc::raw::pack(ds, as_type<futureio::bytes>(obj.obj.data));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<futureio::chain::action_receipt>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.receiver.value));
   fc::raw::pack(ds, as_type<futureio::chain::digest_type>(obj.obj.act_digest));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.global_sequence));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.recv_sequence));
   history_serialize_container(ds, obj.db, as_type<flat_map<futureio::name, uint64_t>>(obj.obj.auth_sequence));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_context_wrapper<bool, futureio::chain::action_trace>& obj) {
   bool  debug_mode = obj.context;
   fc::raw::pack(ds, fc::unsigned_int(0));
   // if (obj.obj.receipt) {
      fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<futureio::chain::action_receipt>(obj.obj.receipt)));
   // }
   fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<futureio::chain::action>(obj.obj.act)));
   ...
   history_context_serialize_container(ds, obj.db, debug_mode,
                                       as_type<std::vector<futureio::chain::action_trace>>(obj.obj.inline_traces));
   return ds;
}
...
datastream<ST>& operator<<(datastream<ST>&                                                    ds,
                           const history_context_wrapper<std::pair<uint8_t, bool>,
                                                         futureio::augmented_transaction_trace>& obj) {
   auto& trace = *obj.obj.trace;
   bool  debug_mode = obj.context.second;
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<futureio::chain::transaction_id_type>(trace.id));
   if (trace.receipt) {
      if (trace.failed_dtrx_trace && trace.receipt->status.value == futureio::chain::transaction_receipt_header::soft_fail)
         fc::raw::pack(ds, uint8_t(futureio::chain::transaction_receipt_header::executed));
      else
   ...
   history_context_serialize_container(ds, obj.db, debug_mode,
                                       as_type<std::vector<futureio::chain::action_trace>>(trace.action_traces));
   ...
   if (trace.failed_dtrx_trace) {
      uint8_t stat = futureio::chain::transaction_receipt_header::hard_fail;
      if (trace.receipt && trace.receipt->status.value == futureio::chain::transaction_receipt_header::soft_fail)
         stat = futureio::chain::transaction_receipt_header::soft_fail;
      std::pair<uint8_t, bool> context = std::make_pair(stat, debug_mode);
      fc::raw::pack(
          ds, make_history_context_wrapper(
                  obj.db, context, futureio::augmented_transaction_trace{trace.failed_dtrx_trace, obj.obj.partial}));
   }
   ...
   if (include_partial) {
      ...
      fc::raw::pack(ds, fc::unsigned_int(0));
      fc::raw::pack(ds, as_type<futureio::chain::time_point_sec>(partial.expiration));
      ...
      fc::raw::pack(ds, as_type<futureio::chain::extensions_type>(partial.transaction_extensions));
      fc::raw::pack(ds, as_type<std::vector<futureio::chain::signature_type>>(partial.signatures));
      fc::raw::pack(ds, as_type<std::vector<futureio::bytes>>(partial.context_free_data));
   }
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                           ds,
                           const history_context_wrapper<bool, futureio::augmented_transaction_trace>&  obj) {
   std::pair<uint8_t, bool> context = std::make_pair(futureio::chain::transaction_receipt_header::hard_fail, obj.context);
   ds << make_history_context_wrapper(obj.db, context, obj.obj);
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const futureio::get_blocks_result_v0& obj) {
