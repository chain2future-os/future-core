...
public:
   ...
   bool sync_fail(const futureio::ReqSyncMsg& sync_msg);
   bool sync_cancel();
...
//FC_REFLECT(futureio::producer_rpos_plugin::runtime_options, (max_transaction_time)(max_irreversible_block_age));
