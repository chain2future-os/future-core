...
#include <futureio/sync_net_plugin/protocol.hpp>
...
//            }
    ...
    void sync_ws_manager::receive_ws_sync_rsp(connection_ptr c, const RspLastWsInfoMsg &msg){
        ...
        do {
            const futureio::chain::ws_info& info = msg.info;
    ...
    sync_blocks_manager::sync_blocks_manager(){
        ...
        m_is_read = true;
        block_dir = fc::app_path() / "futureio/nodfuture/data/blocks/";
        max_try_cnt = 2;
        ip_address = "";
    }
            ...
            [this,weak_conn]( boost::system::error_code ec, std::size_t bytes_transferred ) {
               ...
               try {
                  if( !ec ) {
                     ...
                     FUTURE_ASSERT(bytes_transferred <= conn->pending_message_buffer.bytes_to_write(), futureio::chain::plugin_exception, "");
