...
FC_REFLECT( futureio::connection_status, (peer)(connecting)(last_handshake) )
FC_REFLECT( futureio::sync_wss_params, (chainId)(hosts) )
FC_REFLECT( futureio::status_code,(code)(des)(host)(msg))
FC_REFLECT( futureio::block_info,(block_height)(first_block_height)(msg))
