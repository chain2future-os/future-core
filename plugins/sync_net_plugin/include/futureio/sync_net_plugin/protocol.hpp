...
FC_REFLECT( futureio::wss::select_ids<fc::sha256>, (mode)(pending)(ids) )
FC_REFLECT( futureio::wss::handshake_message,
            (network_version)(node_id)(time)(p2p_address)
            (os)(agent)(generation) )
FC_REFLECT( futureio::wss::go_away_message, (reason)(node_id) )
FC_REFLECT( futureio::wss::time_message, (org)(rec)(xmt)(dst) )
FC_REFLECT( futureio::wss::ReqLastWsInfoMsg, (chain_id)(block_height) )
FC_REFLECT( futureio::wss::RspLastWsInfoMsg, (info) )
FC_REFLECT( futureio::wss::ReqWsFileMsg, (lenPerSlice)(index)(info) )
FC_REFLECT( futureio::wss::FileTransferPacket, (chunkLen)(chunkHashString)(sliceId)(endOfFile)(chunk) )
FC_REFLECT( futureio::wss::TimeInfo, (reqTime)(rspTime) )
FC_REFLECT( futureio::wss::ReqTestTimeMsg, (timeInfo)(size)(chunk) )
FC_REFLECT( futureio::wss::RspTestTimeMsg, (timeInfo)(chunk) )
FC_REFLECT( futureio::wss::ReqBlocksInfoMsg, (chain_id)(block_height) )
FC_REFLECT( futureio::wss::RspBlocksInfoMsg, (chain_id)(block_height)(gs) )
FC_REFLECT( futureio::wss::ReqBlocksFileMsg, (block_num) )
FC_REFLECT( futureio::wss::BlocksTransferPacket, (chunkLen)(block_num)(block) )
