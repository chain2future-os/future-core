...
#include <futureio/chain/asset.hpp>
...
#include <futureio/chain/plugin_interface.hpp>
...
//   };
   ...
   struct anchors_data {
      asset    supply;
      uint32_t first;
      std::vector<anchor_info> anchors;
   };

   struct get_anchors_result {
      std::vector<anchor_info> anchors;
   };

   get_anchors_result get_anchors( const get_anchors_params& params) const;
#endif
   ...
   using get_node_account_params = empty;
   vector<string> get_node_account( const get_node_account_params& ) const;
...
FC_REFLECT( futureio::chain_apis::permission, (perm_name)(parent)(required_auth) )
FC_REFLECT( futureio::chain_apis::resourcelease, (chain_name)(lease_num)(locked_num)(start_time)(end_time) )
FC_REFLECT(futureio::chain_apis::empty, )
FC_REFLECT(futureio::chain_apis::read_only::get_info_results,
...
FC_REFLECT(futureio::chain_apis::read_only::get_block_info_params, (block_num_or_id))
FC_REFLECT(futureio::chain_apis::read_only::get_block_header_state_params, (block_num_or_id))

FC_REFLECT( futureio::chain_apis::read_write::push_tx_results, (transaction_id)(processed) )

FC_REFLECT( futureio::chain_apis::read_only::get_table_records_params, (json)(code)(scope)(table)(table_key_type)(table_key)(scope_type)(lower_bound)(upper_bound)(limit)(key_type)(index_position) )
FC_REFLECT( futureio::chain_apis::read_only::get_table_records_result, (rows)(more) );

FC_REFLECT( futureio::chain_apis::read_only::get_table_by_scope_params, (code)(table)(lower_bound)(upper_bound)(limit) )
FC_REFLECT( futureio::chain_apis::read_only::get_table_by_scope_result_row, (code)(scope)(table)(payer)(count));
FC_REFLECT( futureio::chain_apis::read_only::get_table_by_scope_result, (rows)(more) );

FC_REFLECT( futureio::chain_apis::read_only::get_currency_balance_params, (code)(account)(symbol));
FC_REFLECT( futureio::chain_apis::read_only::get_currency_stats_params, (code)(symbol));
FC_REFLECT( futureio::chain_apis::read_only::get_currency_stats_result, (supply)(max_supply)(issuer));
FC_REFLECT( futureio::chain_apis::read_only::get_subchain_committee_params, (chain_name));
FC_REFLECT( futureio::chain_apis::read_only::get_subchain_committee_result, (owner)(miner_pk)(bls_pk) );
FC_REFLECT( futureio::chain_apis::read_only::block_num_and_id, (number)(block_id));
FC_REFLECT( futureio::chain_apis::read_only::get_subchain_block_num_result, (confirmed_block)(forks));
FC_REFLECT( futureio::chain_apis::read_only::get_subchain_unconfirmed_header_params, (chain_name));
FC_REFLECT( futureio::chain_apis::read_only::get_subchain_unconfirmed_header_result, (confirmed_block_id)(next_committee_mroot)(committee_set)(unconfirmed_headers)(genesisPk));
FC_REFLECT( futureio::chain_apis::read_only::get_producer_info_params, (owner) );
FC_REFLECT( futureio::chain_apis::read_only::get_producer_info_result, (location)(chain_id)(genesis_time)(quit_before_num)(genesis_pk) );
FC_REFLECT( futureio::chain_apis::read_only::get_random_params, (blocknum) );
FC_REFLECT( futureio::chain_apis::read_only::get_random_result, (random) );
FC_REFLECT( futureio::chain_apis::read_only::get_producers_params, (json)(lower_bound)(all_chain)(chain_name) )
FC_REFLECT( futureio::chain_apis::read_only::producer_with_location, (chain_name)(prod_detail))
FC_REFLECT( futureio::chain_apis::read_only::get_producers_result, (rows)(more) );
FC_REFLECT( futureio::chain_apis::read_only::exten_type, (key)(value) );
FC_REFLECT( futureio::chain_apis::read_only::get_confirm_point_interval_params, (dummy) );
FC_REFLECT( futureio::chain_apis::read_only::get_confirm_point_interval_result, (confirm_point_interval) );
FC_REFLECT( futureio::chain_apis::read_only::get_max_bax_count_result_params, (dummy) );
FC_REFLECT( futureio::chain_apis::read_only::get_max_bax_count_result, (max_bax_count) );
FC_REFLECT( futureio::chain_apis::read_only::get_global_exten_params, (index) );
FC_REFLECT( futureio::chain_apis::read_only::get_global_exten_result, (global_exten_data) );

FC_REFLECT(futureio::chain_apis::read_only::get_account_results,
...
FC_REFLECT(futureio::chain_apis::read_only::account_exist_result,(is_exist))
FC_REFLECT( futureio::chain_apis::read_only::get_scheduled_transactions_params, (json)(lower_bound)(limit) )
FC_REFLECT( futureio::chain_apis::read_only::get_scheduled_transactions_result, (transactions)(more) );
FC_REFLECT( futureio::chain_apis::read_only::get_contract_results, (account_name)(code_hash)(wast)(wasm)(abi) )
FC_REFLECT( futureio::chain_apis::read_only::get_abi_results, (account_name)(abi) )
FC_REFLECT( futureio::chain_apis::read_only::get_account_info_params, (account_name) )
FC_REFLECT( futureio::chain_apis::read_only::get_account_exist_params, (account_name) )
FC_REFLECT( futureio::chain_apis::read_only::get_trans_fee_params, (block_height) )
FC_REFLECT(futureio::chain_apis::read_only::trans_fee_result,(fee))
FC_REFLECT( futureio::chain_apis::read_only::get_contract_params, (account_name)(code_as_wasm) )
FC_REFLECT( futureio::chain_apis::read_only::get_abi_params, (account_name) )
FC_REFLECT( futureio::chain_apis::read_only::get_raw_code_and_abi_params, (account_name) )
FC_REFLECT( futureio::chain_apis::read_only::get_raw_code_and_abi_results, (account_name)(wasm)(abi) )
//FC_REFLECT( futureio::chain_apis::read_only::producer_info, (producer_name) )
FC_REFLECT( futureio::chain_apis::read_only::abi_json2bin_params, (code)(action)(args) )
FC_REFLECT( futureio::chain_apis::read_only::abi_json2bin_result, (binargs) )
FC_REFLECT( futureio::chain_apis::read_only::abi_bin2json_params, (code)(action)(binargs) )
FC_REFLECT( futureio::chain_apis::read_only::abi_bin2json_result, (args) )
FC_REFLECT( futureio::chain_apis::read_only::get_required_keys_params, (transaction)(available_keys) )
FC_REFLECT( futureio::chain_apis::read_only::get_required_keys_result, (required_keys) )
FC_REFLECT( futureio::chain_apis::read_only::get_whiteblacklist_result, (actor_whitelist)(actor_blacklist)(contract_whitelist)(contract_blacklist)(action_blacklist)(key_blacklist) )

FC_REFLECT( futureio::chain_apis::read_write::register_event_params, (account)(post_url));
FC_REFLECT( futureio::chain_apis::read_write::unregister_event_params, (account)(post_url));
FC_REFLECT( futureio::chain_apis::read_write::register_result, (result));

FC_REFLECT( futureio::chain_apis::read_only::get_merkle_proof_params, (block_number)(trx_id));
FC_REFLECT( futureio::chain_apis::read_only::get_merkle_proof_result, (merkle_proof)(trx_receipt_bytes));
FC_REFLECT( futureio::chain_apis::read_only::verify_merkle_proof_params, (merkle_proof)(transaction_mroot)(trx_receipt_bytes));
FC_REFLECT( futureio::chain_apis::read_only::verify_merkle_proof_result, (is_matched));
FC_REFLECT( futureio::chain_apis::read_only::get_resource_orders_params, (period_id));
FC_REFLECT( futureio::chain_apis::read_only::get_resource_orders_result, (owner)(lease_num)(initial_unit_price)(decrease_by_day)(current_price));

#ifdef ENABLE_ZKP
FC_REFLECT( futureio::chain_apis::read_only::get_anchors_params, (code)(scope)(start)(end));
FC_REFLECT( futureio::chain_apis::read_only::anchor_info, (pos)(cm)(anchor));
FC_REFLECT( futureio::chain_apis::read_only::anchors_data, (supply)(first)(anchors));
FC_REFLECT( futureio::chain_apis::read_only::get_anchors_result, (anchors));
#endif
