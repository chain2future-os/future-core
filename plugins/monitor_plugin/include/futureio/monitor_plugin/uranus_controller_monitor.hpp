        ...
        BlockHeaderDigest findProposeMsgByBlockId(const chain::block_id_type& bid) const {
            ...
            if (pController) {
                ...
                if(ite != pController->m_proposerMsgMap.end()){
                    ...
                    FUTURE_THROW(chain::msg_not_found_exception, "Propose msg not found by id." );
                }
            }
        ...
        EchoMsgInfoDigest findEchoMsgByBlockId(const chain::block_id_type& bid) const {
            ...
            if (pController) {
                ...
                if(ite != pController->m_echoMsgMap.end()) {
                    ...
                    FUTURE_THROW(chain::msg_not_found_exception, "Echo msg info not found by id." );
                }
            }
        ...
        std::vector<BlockHeaderDigest> findProposeCacheByKey(const RoundInfo& info) const {
            ...
            if (pController) {
                ...
                if(ite != pController->m_cacheProposeMsgMap.end()) {
                    ...
                    FUTURE_THROW(chain::msg_not_found_exception, "Propose msg not found by key." );
                }
            }
        ...
        std::vector<EchoMsgDigest> findEchoCacheByKey(const RoundInfo& info) const {
            ...
            if (pController) {
                ...
                if(ite != pController->m_cacheEchoMsgMap.end()) {
                    ...
                    FUTURE_THROW(chain::msg_not_found_exception, "Echo msg not found by key." );
                }
            }
        ...
        echo_msg_digest_vect findEchoApMsgByKey(const RoundInfo& info) const {
            ...
            if (pController) {
                ...
                if(ite != pController->m_echoMsgAllPhase.end()) {
                    ...
                    FUTURE_THROW(chain::msg_not_found_exception, "Echo msg info not found by key." );
                }
            }
