    ...
    public:
        ...
        void getNodeData(periodic_report_dynamic_data& reportData) {
            ...
            if (pNode) {
                ...
                reportData.version = futureio::utilities::common::itoh(static_cast<uint32_t>(app().version()));
        ...
        periodic_report_static_data getStaticConfigInfo() const {
            ...
            std::shared_ptr<Node> pNode = m_pNode.lock();
            if (pNode) {
                staticConfig.version           = futureio::utilities::common::itoh(static_cast<uint32_t>(app().version()));
...
FC_REFLECT( futureio::periodic_report_dynamic_data, (nodeIp)(chainId)(minerName)(blockNum)(dbFreeMem)(phase)(baxCount)(transactionNum)(blockProposer)(syncing)
...
FC_REFLECT( futureio::periodic_report_static_data, (nodeIp)(chainId)(version)(nonProducingNode)(genesisLeaderPk)(publicKey)
