...
FC_REFLECT( futureio::monitor_apis::monitor_only::monitor_node_params, )
FC_REFLECT( futureio::monitor_apis::monitor_only::monitor_node_result, (ready)(connected)(syncing)(syncFailed)
...
FC_REFLECT( futureio::monitor_apis::monitor_only::monitor_propose_msg_params, (block_id) )
FC_REFLECT( futureio::monitor_apis::monitor_only::monitor_propose_msg_result, (myid)(blockNum) )
FC_REFLECT( futureio::EchoMsgDigest, (head)(phase)(baxCount) )
FC_REFLECT( futureio::monitor_apis::monitor_only::monitor_echo_msg_result, (echoMsg)(hasSend)(accountPoolSize)(account_pool) )

FC_REFLECT( futureio::monitor_apis::monitor_only::monitor_propose_cache_params, (blockNum)(phase) )
FC_REFLECT( futureio::monitor_apis::monitor_only::monitor_propose_cache_result, (proposeCache) )

FC_REFLECT( futureio::monitor_apis::monitor_only::monitor_echo_cache_result, (echoCache) )

FC_REFLECT( futureio::monitor_apis::monitor_only::monitor_echo_ap_cache_result, (echoApCache) )

FC_REFLECT( futureio::alert_info, (alertType)(chainName)(blockNum)(nodeInfo)(reason)(remark) )
