...
public:
   ...
   void set_futureio_key(const std::string& key) { futureio_key = key; }
   ...
   /// @param password the plaintext password returned from ::create.
   /// @param key the Public Key to remove, e.g. FUTURE6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
