...
#include <futureio/wallet_plugin/wallet_api.hpp>
...
class soft_wallet final : public wallet_api
{
   public:
       ...
       *
       * example: remove_key FUTURE6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
       *
...
FC_REFLECT( futureio::wallet::wallet_data, (cipher_keys) )

FC_REFLECT( futureio::wallet::plain_keys, (checksum)(keys) )
