...
#include <futureio/kcp_plugin/kcp_plugin.hpp>
...
namespace futureio { namespace kcp_plugin_n {
...
connection::connection(string endpoint, msg_priority pri, connection_direction dir)
    ...
    bool kcp_plugin_impl::send_req_sync(const futureio::ReqSyncMsg& msg) {
...
//            ("phase", (uint32_t)msg.phase)("baxcount",msg.baxCount)("account", std::string(msg.account))("sig", short_sig(msg.signature)));
   ...
   void kcp_plugin_impl::handle_message( connection_ptr c, const ProposeMsg& msg) {
    ...
    void kcp_plugin_impl::handle_message( connection_ptr c, const futureio::ReqBlockNumRangeMsg& msg) {
    ...
    void kcp_plugin_impl::handle_message( connection_ptr c, const futureio::RspBlockNumRangeMsg& msg) {
    ...
    void kcp_plugin_impl::handle_message( connection_ptr c, const futureio::ReqSyncMsg& msg) {
    ...
    void kcp_plugin_impl::handle_message( connection_ptr c, const futureio::SyncBlockMsg& msg) {
    ...
    void kcp_plugin_impl::handle_message( connection_ptr c, const futureio::SyncStopMsg &msg) {
...
bool kcp_plugin_impl::authenticate_peer(const handshake_message& msg) {
   ...
   {
      cfg.add_options()
         ( "kcp-agent-name", bpo::value<string>()->default_value("\"FUTURE KCP Agent\""), "The name supplied to identify this node amongst the peers.")
   ...
   void kcp_plugin::send_block(const fc::sha256& node_id, const futureio::SyncBlockMsg& msg) {
   ...
   bool kcp_plugin::send_req_sync(const futureio::ReqSyncMsg& msg) {
       ilog("send req sync msg");
       return my->send_req_sync(msg);
   }

   void kcp_plugin::send_block_num_range(const fc::sha256& node_id, const futureio::RspBlockNumRangeMsg& msg) {
