...
FC_REFLECT( futureio::p2p::Reserved, (key)(content))
FC_REFLECT( futureio::p2p::UnsignedPingNode, (sourceid)(destid)(type)(source)(dest)(chain_id)(pk)(account)(to_save))
FC_REFLECT_DERIVED( futureio::p2p::PingNode, (futureio::p2p::UnsignedPingNode), (signature))
FC_REFLECT( futureio::p2p::UnsignedPong, (type)(fromep)(destep)(sourceid)(destid)(chain_id)(pk)(account)(to_save))
FC_REFLECT_DERIVED( futureio::p2p::Pong, (futureio::p2p::UnsignedPong), (signature))
FC_REFLECT( futureio::p2p::UnsignedFindNode, (type)(fromID)(targetID)(destid)(fromep)(tartgetep)(chain_id)(pk)(account)(to_save))
FC_REFLECT_DERIVED( futureio::p2p::FindNode, (futureio::p2p::UnsignedFindNode), (signature))
FC_REFLECT( futureio::p2p::Neighbour, (node)(endpoint))
FC_REFLECT( futureio::p2p::UnsignedNeighbours, (type)(fromID)(destid)(fromep)(tartgetep)(neighbours)(chain_id)(pk)(account)(to_save))
FC_REFLECT_DERIVED( futureio::p2p::Neighbours, (futureio::p2p::UnsignedNeighbours), (signature))
FC_REFLECT( futureio::p2p::UnsignedConnectMsg, (type)(peer)(pri)(sourceid)(chain_id)(pk)(account)(to_save))
FC_REFLECT_DERIVED( futureio::p2p::ConnectMsg, (futureio::p2p::UnsignedConnectMsg), (signature))
FC_REFLECT( futureio::p2p::UnsignedConnectAckMsg, (type)(peer)(pri)(sourceid)(chain_id)(pk)(conv)(account)(to_save))
FC_REFLECT_DERIVED( futureio::p2p::ConnectAckMsg, (futureio::p2p::UnsignedConnectAckMsg), (signature))
FC_REFLECT( futureio::p2p::UnsignedNewPing, (sourceid)(destid)(type)(source)(dest)(chain_id)(pri)(pk)(account)(to_save))
FC_REFLECT_DERIVED( futureio::p2p::NewPing, (futureio::p2p::UnsignedNewPing), (signature))
FC_REFLECT( futureio::p2p::UnsignedSessionCloseMsg, (type)(sourceid)(chain_id)(pk)(account)(conv)(todel)(to_save))
FC_REFLECT_DERIVED( futureio::p2p::SessionCloseMsg, (futureio::p2p::UnsignedSessionCloseMsg), (signature))
FC_REFLECT( futureio::p2p::NatTypeReqMsg, (type))
FC_REFLECT( futureio::p2p::NatTypeRspMsg, (nat_type))
FC_REFLECT( futureio::p2p::NatPunchReqSyncMsg,(sendsrc)(reqsrc)(reqdst)(reqsrc_name))
FC_REFLECT( futureio::p2p::NatPunchReqAckMsg,(sendsrc)(reqsrc)(reqdst)(reqsrc_name))
FC_REFLECT( futureio::p2p::NatPunchRspAckMsg,(sendsrc)(reqsrc)(reqdst))
FC_REFLECT( futureio::p2p::NatPunchNotifyMsg,(peer_info))
