...
FC_REFLECT( futureio::select_ids<fc::sha256>, (mode)(pending)(ids) )
FC_REFLECT( futureio::chain_size_message,
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id))
FC_REFLECT( futureio::handshake_message,
            (network_version)(chain_id)(node_id)(key)
            (time)(token)(sig)(p2p_address)
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id)
            (os)(agent)(generation)(account)(ext) )
FC_REFLECT( futureio::go_away_message, (reason)(node_id) )
FC_REFLECT( futureio::time_message, (org)(rec)(xmt)(dst) )
FC_REFLECT( futureio::notice_message, (known_trx)(known_blocks) )
FC_REFLECT( futureio::request_message, (req_trx)(req_blocks) )
FC_REFLECT( futureio::listen_port, (port)(business_type) )
